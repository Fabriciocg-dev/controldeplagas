...
function DetalleDesinfecciones() {
  ...
  const cargarRegistros = async () => {
    setCargando(true)
    let query = supabase.from('desinfecciones').select('*').order('fecha', { ascending: false })
  ...
  return (
    <div>
      <nav className="navbar no-print">
        <div>
          <p className="navbar-title">Control de Desinfecciones</p>
      ...
      <div className="solo-print" style={styles.printHeader}>
        ...
        <p style={styles.printTitulo}>REGISTRO DE DESINFECCIÓN / DESINSECTACIÓN — Anexo N°6</p>
      ...
      <div className="content">
        <p className="section-title no-print">Registros de Desinfecciones</p>
        ...
        <div className="tabla-reciente">
          <div className="fila-reciente" style={styles.encabezado}>
            ...
            <span style={styles.colChico}>DSF</span>
            <span style={styles.colChico}>DSN</span>
            ...
            registros.map((r) => (
              <div key={r.id} className="fila-reciente">
                ...
                <span style={styles.colChico}>
                  <span style={{ ...styles.badge, backgroundColor: r.dsf ? '#2ecc71' : '#ccc' }}>
                    {r.dsf ? 'Sí' : 'No'}
                  </span>
                </span>
                <span style={styles.colChico}>
                  <span style={{ ...styles.badge, backgroundColor: r.dsn ? '#3498db' : '#ccc' }}>
                    {r.dsn ? 'Sí' : 'No'}
                  </span>
                </span>
...
const styles = {
  ...
  colChico: { flex: '0 0 60px', textAlign: 'center' },
...
export default DetalleDesinfecciones
