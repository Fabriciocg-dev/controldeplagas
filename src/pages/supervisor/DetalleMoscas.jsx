...
function DetalleMoscas() {
  ...
  const cargarRegistros = async () => {
    setCargando(true)
    let query = supabase.from('control_moscas').select('*').order('fecha', { ascending: false })
  ...
  return (
    <div>
      ...
      <div className="solo-print" style={styles.printHeader}>
        ...
        <p style={styles.printTitulo}>REGISTRO DE CONTROL DE MOSCAS</p>
      ...
      <div className="content">
        <p className="section-title no-print">Registros de Control de Moscas</p>
        ...
        <div className="tabla-reciente">
          <div className="fila-reciente" style={styles.encabezado}>
            ...
            <span style={styles.col}>Cebo utilizado</span>
            ...
            registros.map((r) => (
              <div key={r.id} className="fila-reciente">
                ...
                <span style={styles.col}>
                  <span style={styles.badge}>{r.cebo_utilizado || '—'}</span>
                </span>
...
const styles = {
  ...
  badge: { backgroundColor: '#f39c12', color: 'white', padding: '3px 10px', borderRadius: '12px', fontSize: '12px', fontWeight: 'bold' },
  filtros: {
